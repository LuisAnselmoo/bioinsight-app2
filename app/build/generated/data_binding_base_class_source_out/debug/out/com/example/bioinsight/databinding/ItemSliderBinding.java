...
public final class ItemSliderBinding implements ViewBinding {
  ...
  private ItemSliderBinding(@NonNull ImageView rootView, @NonNull ImageView imageViewSlider) {
  ...
  public static ItemSliderBinding bind(@NonNull View rootView) {
    ...
    ImageView imageViewSlider = (ImageView) rootView;

    return new ItemSliderBinding((ImageView) rootView, imageViewSlider);
  }
}
